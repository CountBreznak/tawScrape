...
with open('woldata.csv', 'wb') as csvfile:
	fieldnames = ['TourNo', 'NumUnique', 'NumPlayersRed', 'NumPlayersBlue', 'NumPlayersGray', ]
	writer = csv.DictWriter(csvfile, fieldnames = fieldnames, delimiter = ';')
	writer.writeheader()
	writer.writerow({'TourNo': nPlGray, 'NumUnique': nPlTotal, 'NumPlayersRed': NumRed,'NumPlayersBlue': NumBlue, 'NumPlayersGray': nPlGray})